...
function TermandConditions() {
  return (
    <div className="privacy-width">
      <div class="container">
        <div class="content-bg all-padding px-5 tandc">
          <div class="row">
            <div class="col-12 text-center">
              <h1 class="internal-main-heading text-center my-4">
                Terms &amp; Conditions
              </h1>
            </div>
          </div>
          ...
          <div class="row terms-privacy">
            <div class="col-12">
              ...
              <p>
                ...
                individual or a single entity) and and it governs your use of
                the Application made available to you by PosterMaker.
              </p>
              ...
              <p>
                The Application is licensed, not sold, to you by for use
              ...
              <p>
                PosterMaker grants you a revocable, non-exclusive,
              ...
              <p>
                ...
                (collectively, "Suggestions") provided by you to with respect to
                the Application shall remain the sole and exclusive property of
              ...
              <p>
                PosterMaker reserves the right to modify, suspend or
              ...
              <p>
                PosterMaker may from time to time provide enhancements or
              ...
              <p>
                ...
                functionalities of the Application. You agree that has no
              ...
              <p>
                You acknowledge and agree that shall not be responsible for any
                Third-Party Services, including their accuracy, completeness,
                timeliness, validity, copyright compliance, legality, decency,
                quality or any other aspect thereof. does not assume and shall
              ...
              <p>
                ...
                PosterMaker may, in its sole discretion, at any time and for any
              ...
              <p>
                ...
                from , in the event that you fail to comply with any provision
                of this Agreement. You may also terminate this Agreement by
                deleting the Application and all copies thereof from your mobile
              ...
              <p>
                Termination of this Agreement will not limit any of s rights or
              ...
              <p>
                You agree to indemnify and hold and its parents, subsidiaries,
                ...
                Application; (b) violation of this Agreement or any law or
              ...
              <p>
                ...
                the maximum extent permitted under applicable law, , on its own
                ...
                trade practice. Without limitation to the foregoing provides no
              ...
              <p>
                Without limiting the foregoing, neither nor any provider makes
                any representation or warranty of any kind, express or implied:
                (i) as to the operation or availability of the Application, or
                ...
                e-mails sent from or on behalf of are free of viruses, scripts,
              ...
              <p>
                ...
                liability of and any of its suppliers under any provision of
              ...
              <p>
                ...
                shall PosterMaker or its suppliers be liable for any special,
                ...
                provision of this Agreement), even if or any supplier has been
              ...
              <p>
                ...
                Items", as that term is defined under 48 C.F.R. §2.101,
                consisting of "Commercial Computer Software" and "Commercial
                Computer Software Documentation", as such terms are used under
                48 C.F.R. §12.212 or 48 C.F.R. §227.7202, as applicable. In
                accordance with 48 C.F.R. §12.212 or 48 C.F.R. §227.7202-1
              ...
              <p>
                You may not export or re-export the Application except as
                authorized by United States law and the laws of the jurisdiction
                in which the Application was obtained.
              </p>
              <p>
                In particular, but without limitation, the Application may not
                be exported or re-exported (a) into or to a nation or a resident
                of any U.S. embargoed countries or (b) to anyone on the U.S.
              ...
              <p>
                By installing or using any component of the Application, you
                represent and warrant that you are not located in, under control
              ...
              <p>
                Poster Maker reserves the right, at its sole discretion, to
              ...
              <p>
                The laws of New Jersey, United States, excluding its conflicts
              ...
              <p>
                ...
                Convention on Contracts for the International Sale of Good.
              </p>
              ...
              <p>
                ...
                regarding your use of the Application and supersedes all prior
              ...
              <p>
                ...
                when you use or purchase other services, which will provide to
